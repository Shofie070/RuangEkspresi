...
import 'package:ruang_ekspresi/profile/riwayat_aktivitas.dart';
...
class _ProfilePageState extends State<ProfilePage> {
  ...
  Future<void> _loadKredensialData() async {
    ...
    setState(() {
      ...
      _userPassword =
          prefs.getString('userPassword') ?? 'Password tidak ditemukan';
    });
  }
  ...
  Future<void> _loadProfileData() async {
    ...
    setState(() {
      ...
      _description =
          prefs.getString('profileDescription') ?? "Belum ada deskripsi diri.";
    });
  }
  ...
  void _openEditProfile() async {
    if (context.mounted) {
      await Navigator.push(
        context,
        MaterialPageRoute(
          builder: (_) => EditProfilePage(username: _userName),
        ),
      );
      _loadProfileData();
    }
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          ...
          _buildButton(
              Icons.history, "Riwayat Aktivitas", _openRiwayatAktivitas),
